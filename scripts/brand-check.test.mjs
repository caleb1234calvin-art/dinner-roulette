...
test("SKILL.md and AGENTS.md name the marker path and bound this script uses", workspaceDocsTestOptions(TEMPLATE_ROOT), () => {
...
test("the sections that own the brand-task prohibition never affirm a wait", workspaceDocsTestOptions(TEMPLATE_ROOT), () => {
...
test("SKILL.md tells the pass to self-check with the flag this CLI accepts", workspaceDocsTestOptions(TEMPLATE_ROOT), () => {
