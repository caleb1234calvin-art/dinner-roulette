...
- The primary strict reconciliation file contains **32 fully reconciled properties**, **2 address-verified/coordinate-pending records**, and **6 explicit review flags**.
- `audit/california-reconciliation-supplement-2026-09-10.json` adds 4 fully reconciled properties: Sky River Casino, Thunder Valley Casino Resort, Viejas Casino & Resort, and Yaamava' Resort & Casino at San Manuel.
- `audit/california-reconciliation-supplement-2-2026-09-10.json` adds **5 more fully reconciled properties**: Sycuan Casino Resort, Soboba Casino Resort, Spotlight 29 Casino, Table Mountain Casino Resort, and Tachi Palace Casino Resort.
- The **combined California strict checkpoint is now 41 fully reconciled properties out of 74 license records**. The supplemental files must be folded into the primary reconciliation during final consolidation rather than counted as separate destinations.
- The latest five were promoted only after property-specific coordinate evidence was obtained: Sycuan uses current Casino Way casino geometry; Soboba uses current casino geometry at Soboba Road; Spotlight 29 uses casino-building geometry consistent with the operator address; Table Mountain uses published rancheria/casino coordinates tied to the current Jackpot Lane property; Tachi Palace uses California CEQAnet project coordinates for the casino-resort expansion site.
- Earlier supplemental work matched Sky River to casino geometry at 1 Sky River Parkway, Thunder Valley to resort/casino property geometry rather than the separate hotel centroid, Viejas to casino-building geometry at 5000 Willows Road, and Yaamava to the casino property at 777 San Manuel Boulevard.
- Property-specific coordinate evidence may be accepted from casino/building OpenStreetMap geometry surfaced through Mapcarta or, where available, government project records such as California CEQAnet. Separate hotel/travel-center geometries must be checked where relevant so the casino destination is not accidentally centered on an adjacent amenity.
...
- Broad California discovery is finished. Remaining work is coordinate consolidation for the researched address-backed properties plus the smaller set of identity/scope/address exceptions.
...
- Next California sequence: reconcile the remaining address-backed properties from both accelerated research files; resolve or explicitly exclude the review cases; merge both supplemental reconciliation files into the primary strict file; determine the justified physical-destination count; generate `src/lib/nightlife/casino-catalog-pass-19.ts`; wire it into `search.ts`; run duplicate/audit/typecheck/tests/build checks; then update `CASINO_AUDIT.md` and this continuity file before declaring California complete.
