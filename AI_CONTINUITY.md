...
**Run 229 (`34672493797`) is green at activation commit `b156f0b02cc9fd6bab30d5a072fb59db5587894c`, validating Nevada Pass 39 active.** Typecheck, curated-casino audit, inherited test-suite report, development build and Dinner icon verification all completed successfully. The validator was subsequently extended through Pass 39 at `0c413978edbc88e7c91a89e2f8889cae721c8110`. Run 229 supersedes Run 225 as the current validated runtime baseline. A green run never authorizes a merge to `main` by itself.
...
Casino runtime is **validated through Pass 39**. Pass 30 adds Oklahoma Duck Creek and Checotah; Pass 31 adds Artesian Casino; Pass 32 adds 15 Nevada NV-02 destinations from Laughlin and Reno-Sparks; Pass 33 adds the complete four-destination Texas set; Pass 34 adds seven QA-cleared rural Nevada destinations; Pass 35 adds ten QA-cleared outer-Clark/Mesquite/Primm Nevada destinations; Pass 36 adds six QA-cleared Boulder Strip/Henderson Nevada destinations; Pass 37 adds four QA-cleared North Las Vegas/northwest-valley destinations; Pass 38 adds Jerry's Nugget Casino; Pass 39 adds Skyline Hotel & Casino and Emerald Island Casino. `src/lib/nightlife/search.ts` imports and appends through Pass 39. `scripts/audit-casino-catalog.mjs` enumerates through Pass 39 and recognizes both inline jurisdiction literals and `JURISDICTION` helper constants. Run 229 validates Pass 39 green.
...
## Nevada — rolling, 95 active runtime destinations
...
`audit/nevada-henderson-coordinate-qa-pass-12-2026-09-12.json` clears **Skyline Hotel & Casino** at **1741 N Boulder Hwy, Henderson, NV 89011**, coordinate **36.06229,-115.00823**, and **Emerald Island Casino** at **120 Market St, Henderson, NV 89015**, coordinate **36.03251,-114.98463**. `src/lib/nightlife/casino-catalog-pass-39.ts` serializes both, raising Nevada active curated runtime from **93 to 95**. Run 229 validates Pass 39 green. The Pass Casino is deliberately held because current first-party casino pages conflict with July 30, 2026 acquisition/closure-for-renovation reporting; do not infer current operation from potentially stale site copy. Rainbow Club remains a coordinate hold rather than being promoted without a direct property-specific numerical point.

Nevada remains pending/rolling rather than statewide complete. Remaining work includes the rest of the Boulder/Henderson segment (Longhorn, the Jokers Wild/Cadence Crossing succession, Club Fortune Henderson, Rainbow Club, Pass Casino, Railroad Pass and Barley's), North Las Vegas successor follow-up for Club Fortune North, and remaining outer-Clark holds such as Arizona Charlie's Decatur and Rancho/Fremont Wildfire. Buffalo Bill's and Whiskey Pete's remain operation-state holds. Bonanza Casino Fallon remains held rather than promoted from weaker coordinate evidence; Red Drag Elko, The Nevada Casino & Bar Battle Mountain, Longstreet normalization and other rural completeness items remain staged until they independently clear the same gate.
...
`audit/texas-runtime-reconciliation-2026-09-12.json` completes stable-ID and duplicate/alias QA. Livingston and Leggett remain distinct current operating destinations. Repeated NIGC Naskila and Speaking Rock rows collapse by physical property. `src/lib/nightlife/casino-catalog-pass-33.ts` serializes all four Texas destinations, and the integration manifest marks Texas complete with expectedCount 4. Run 229 confirms the combined runtime remains green.
