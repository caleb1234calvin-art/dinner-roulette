...
**Run 240 (`34672995599`) is green at validator commit `245366081ed6253f218f2de08680f0059bdb9541`, validating Nevada Pass 41 active with the validator extended through Pass 41.** Typecheck, curated-casino audit, inherited test-suite report, development build and Dinner icon verification all completed successfully. Run 240 supersedes Run 234 as the current validated runtime baseline. A green run never authorizes a merge to `main` by itself.
...
Casino runtime is **validated through Pass 41**. Pass 30 adds Oklahoma Duck Creek and Checotah; Pass 31 adds Artesian Casino; Pass 32 adds 15 Nevada NV-02 destinations from Laughlin and Reno-Sparks; Pass 33 adds the complete four-destination Texas set; Pass 34 adds seven QA-cleared rural Nevada destinations; Pass 35 adds ten QA-cleared outer-Clark/Mesquite/Primm Nevada destinations; Pass 36 adds six QA-cleared Boulder Strip/Henderson Nevada destinations; Pass 37 adds four QA-cleared North Las Vegas/northwest-valley destinations; Pass 38 adds Jerry's Nugget Casino; Pass 39 adds Skyline Hotel & Casino and Emerald Island Casino; Pass 40 adds five more Nevada destinations across Boulder/Henderson and outer Clark; Pass 41 adds Club Fortune Casino in Henderson and Rainbow Club Casino. `src/lib/nightlife/search.ts` imports and appends through Pass 41. `scripts/audit-casino-catalog.mjs` enumerates through Pass 41 and recognizes both inline jurisdiction literals and `JURISDICTION` helper constants. Run 240 validates Pass 41 green.
...
## Nevada — rolling, 102 active runtime destinations
...
`audit/nevada-boulder-outer-clark-coordinate-qa-pass-13-2026-09-12.json` clears **five additional destinations**: **Longhorn Hotel & Casino, Railroad Pass Casino & Hotel, Barley's Casino & Brewery Co., Arizona Charlie's Decatur and Wildfire Rancho.** `src/lib/nightlife/casino-catalog-pass-40.ts` serializes those five and raises Nevada active curated runtime from **95 to 100**. Arizona Charlie's Decatur remains distinct from Arizona Charlie's Boulder; Wildfire Rancho remains distinct from Wildfire Boulder/Fremont; Railroad Pass uses the casino-building point rather than nearby travel-center/trailhead coordinates.

`audit/nevada-henderson-successor-coordinate-qa-pass-14-2026-09-12.json` clears **Club Fortune Casino** at **725 S Racetrack Rd, Henderson, NV 89015**, coordinate **36.01776,-114.94821**, and **Rainbow Club Casino** at **122 S Water St, Henderson, NV 89015**, coordinate **36.03269,-114.98372**. `src/lib/nightlife/casino-catalog-pass-41.ts` serializes both and raises Nevada active curated runtime from **100 to 102**. The same QA pass explicitly reconciles the Jokers Wild/Cadence Crossing lineage: Boyd's 2026 SEC filing says **Cadence Crossing opened March 25, 2026 and replaced Jokers Wild**, with demolition of Jokers Wild beginning in Q1 2026. Jokers Wild must not be emitted as current. Cadence Crossing is current at 920 N Boulder Hwy but remains held only for a direct property-specific numerical point for the new footprint. Run 240 validates Pass 41 green.

Nevada remains pending/rolling rather than statewide complete. Remaining work includes Cadence Crossing coordinate QA, The Pass operation-state conflict, Club Fortune North successor follow-up, Wildfire on Fremont, Buffalo Bill's and Whiskey Pete's operation-state holds, Bonanza Casino Fallon coordinate QA, Red Drag Elko, The Nevada Casino & Bar Battle Mountain, Longstreet normalization and other rural completeness items. The Nevada Casino & Bar has current-operation and OSM-point evidence but remains held because a stable current first-party property website has not been established. Do not weaken the evidence gate merely to increase the runtime count.
...
`audit/texas-runtime-reconciliation-2026-09-12.json` completes stable-ID and duplicate/alias QA. Livingston and Leggett remain distinct current operating destinations. Repeated NIGC Naskila and Speaking Rock rows collapse by physical property. `src/lib/nightlife/casino-catalog-pass-33.ts` serializes all four Texas destinations, and the integration manifest marks Texas complete with expectedCount 4. Run 240 confirms the combined runtime remains green.
