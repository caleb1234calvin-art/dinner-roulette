...
- The primary strict reconciliation file currently contains **32 fully reconciled properties**, **2 address-verified/coordinate-pending records**, and **6 explicit review flags**.
- A supplemental strict reconciliation file, `audit/california-reconciliation-supplement-2026-09-10.json`, adds **4 more fully reconciled properties**: Sky River Casino, Thunder Valley Casino Resort, Viejas Casino & Resort, and Yaamava' Resort & Casino at San Manuel. Therefore the combined California strict checkpoint is now **36 fully reconciled properties out of 74 license records**. Merge the supplement into the primary file during final consolidation.
- Sky River was matched to OpenStreetMap casino geometry at 1 Sky River Parkway; Thunder Valley used the resort/casino property geometry rather than the separate hotel centroid; Viejas matched casino-building geometry at 5000 Willows Road; Yaamava matched the casino property at 777 San Manuel Boulevard.
- Earlier coordinate/reconciliation work promoted Eagle Mountain, Elk Valley, Fantasy Springs, Feather Falls, Gold Country, Golden Acorn, Graton, Hard Rock Tejon, Hard Rock Sacramento, Havasu Landing, Jackson Rancheria, Jamul, Konocti Vista, Lucky 7, Pala, Pechanga, Pit River, Quechan, and Rain Rock in addition to the original strict set.
...
- Next California sequence: reconcile the remaining address-backed properties from both accelerated research files; resolve or explicitly exclude the review cases; merge the supplemental reconciliations into the primary strict file; determine the justified physical-destination count; generate `src/lib/nightlife/casino-catalog-pass-19.ts`; wire it into `search.ts`; run duplicate/audit/typecheck/tests/build checks; then update `CASINO_AUDIT.md` and this continuity file before declaring California complete.
